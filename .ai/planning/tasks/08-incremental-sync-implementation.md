...
- Test incremental sync uses stored token
- Test only changed contacts are updated
- Test deleted contacts are marked as deleted
- Test sync token is updated after sync

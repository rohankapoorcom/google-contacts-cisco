...
class TestSearchAPIIntegration:
    ...
    def test_search_contacts_by_name(self, integration_client, integration_test_contacts):
    ...
    def test_search_contacts_by_partial_name(self, integration_client, integration_test_contacts):
    ...
    def test_search_contacts_by_phone_number(self, integration_client, integration_test_contacts):
    ...
    def test_search_case_insensitive(self, integration_client, integration_test_contacts):
    ...
    def test_search_special_characters(self, integration_client, integration_test_contacts):
    ...
    def test_search_with_pagination(self, integration_client, integration_test_contacts):
...
class TestSearchPerformance:
    ...
    def test_search_performance_with_large_dataset(self, integration_client, integration_db):

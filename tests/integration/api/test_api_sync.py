...
class TestSyncAPIIntegration:
    ...
    def test_full_sync_creates_contacts(
        self, mock_google_client_class, integration_client, integration_db, mock_credentials
    ):
    ...
    def test_incremental_sync_updates_contacts(
        self, mock_google_client_class, integration_client, integration_test_contacts, 
    ...
    def test_sync_status_updates_during_sync(self, integration_client):
        ...
        assert initial_status["status"] in ["idle", "never_synced", "IDLE", "NEVER_SYNCED"]

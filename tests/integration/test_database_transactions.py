...
class TestDatabaseTransactionIntegration:
    ...
    def test_contact_creation_commits(self, integration_db):
        ...
        retrieved = (
            ...
            .filter_by(resource_name="people/txn_test_1")
            .first()
        )
    ...
    def test_rollback_on_error(self, integration_db):
        ...
        result = (
            integration_db.query(Contact)
            .filter_by(resource_name="people/rollback_test")
            .first()
        )
    ...
    def test_nested_transaction_rollback(self, integration_db):
        ...
        result = (
            integration_db.query(Contact)
            .filter_by(resource_name="people/nested_test")
            .first()
        )
    ...
    def test_cascade_delete_phone_numbers(self, integration_db):
        ...
        integration_db.expire_all()
        remaining_contact = (
            integration_db.query(Contact).filter_by(id=contact_id).first()
        )
        assert remaining_contact is None

        # Phone should be deleted due to cascade
        remaining_phone = (
            integration_db.query(PhoneNumber).filter_by(id=phone_id).first()
        )
    ...
    def test_foreign_key_constraint(self, integration_db):
        ...
        try:
            integration_db.commit()
            # If commit succeeds, FK constraints may not be enforced
...
class TestDatabaseConcurrency:
    ...
    def test_concurrent_contact_creation(self, integration_db):
        ...
        count = (
            integration_db.query(Contact)
            .filter(Contact.resource_name.like("people/concurrent_%"))
            .count()
        )
    ...
    def test_bulk_insert_performance(self, integration_db):
        ...
        count = (
            integration_db.query(Contact)
            .filter(Contact.resource_name.like("people/bulk_%"))
            .count()
        )
        assert count == 100
...
class TestDatabaseDataIntegrity:
    ...
    def test_timestamp_fields_populated(self, integration_db):
        ...
        retrieved = (
            integration_db.query(Contact)
            .filter_by(resource_name="people/timestamp_test")
            .first()
        )
...
class TestDatabasePerformance:
    ...
    def test_query_performance_with_joins(self, integration_db):
        ...
        contacts = (
            ...
            .filter(Contact.resource_name.like("people/query_perf_%"))
            .all()
        )
    ...
    def test_index_effectiveness(self, integration_db):
        ...
        result = (
            integration_db.query(Contact)
            .filter_by(resource_name="people/index_test_50")
            .first()
        )

...
class TestTimezoneHandling:
    ...
    def test_contact_response_formats_timestamps_with_timezone(
        ...
        with patch(
            "google_contacts_cisco.schemas.contact.get_settings"
        ) as mock_settings:
    ...
    def test_api_responses_include_timezone_aware_timestamps(
        self, integration_db: Session
    ):
...
class TestTimezoneConsistency:
    ...
    def test_timestamps_maintain_consistency_through_update(
        self, integration_db: Session
    ):
